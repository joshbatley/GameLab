...
void InputSystem::SetupCursor(Engine::World &world, Asset::Registry &asset)
{
...
void InputSystem::GenerateNewMap(Engine::World &_, Event::Registry &eventRegistry, Input::Manager &input)
{
...
void InputSystem::UpdateTile(Engine::World &world, Event::Registry &eventRegistry, Input::Manager &input, Engine::Resource<GameData> resource)
{
