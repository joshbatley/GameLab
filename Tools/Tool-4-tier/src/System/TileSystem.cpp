...
void TileSystem::Setup(Engine::World &world, Event::Registry &eventRegistry, Asset::Registry &asset)
{
...
void TileSystem::ReloadWorld(Engine::World &world, Event::Registry &eventRegistry, RefreshWorldEvent _)
{
    auto &tileArray = world.get<TileArray>(world.view<TileArray>().front());
    auto &noise = Noise::getInstance();
...
void TileSystem::UpdateTile(Engine::World &world, Event::Registry &eventRegistry, UpdateTileEvent ev)
{
    auto &tileArray = world.get<TileArray>(world.view<TileArray>().front());
